...
<nav class="navbar">
  ...
  <center>
    <div class="slideshow-container">
      ...
      <div class="mySlides fade">
        <img src="pm_pic_banner1.jpg" style="width: 1500px;" >
      </div>

      <div class="mySlides fade">
        <img src="banner2.jpg" style="width:60%">
      </div>

      <div class="mySlides fade">
        <img src="banner3.jpg" style="width:60%">
      </div>

      <div class="mySlides fade">
        <img src="banner4.jpg" style="width:50%;">
      </div>
  </center>
  <br>
  ...
  <div class="container">
    ...
    <div class="instructions">
      ...
      <p>Follow the instructions below to obtain your license-<s/p>
      <ol>
